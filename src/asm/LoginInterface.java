...
public class LoginInterface extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("you didnt have account ?");
...
if (username.isEmpty() || password.isEmpty()) {
    ...
    try {
        ...
        reader.close();
        if (success) {
            // Login successful, open Maininterface.java
    ...
    private void RegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegisterActionPerformed
        // TODO add your handling code here: // create a new instance of Register window
    Register registerWindow = new Register();
    
    // set the visibility of the Register window to true
